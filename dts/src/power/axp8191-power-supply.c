...
/* ADC enable bits (AXP8191-specific, derived from init code patterns) */
...
#define AXP8191_PS_VBUS_GOOD		BIT(5)
#define AXP8191_PS_ACIN_GOOD		BIT(4)

/* VBUS_STATUS bits */
#define AXP8191_VS_VBUS_HOLDS		BIT(7)
